...
export default function Side() {
  return (
    <>
      <div className="fixed bottom-0 hidden w-12 translate-x-1/2 flex-col items-center rounded-full backdrop-blur-sm after:inline-block after:h-32 after:w-[3px] after:rounded-full after:bg-cCommon-black after:content-[''] after:dark:bg-cCommon-white sm:right-12 sm:flex sm:gap-2">
